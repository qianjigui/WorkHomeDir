...
function! s:DB_getDefault(name)
    ...
    elseif a:name ==# "history_file"            |return (exists("g:dbext_default_history_file")?g:dbext_default_history_file.'':(has('win32')?$VIM.'/history/dbext_sql_history.txt':$HOME.'/.vim/history/dbext_sql_history.txt'))
